# 🎮 **Gaming Industry Popularity Analysis**

[![GitHub last commit](https://img.shields.io/github/last-commit/alvie978/Gaming-studies)](https://github.com/alvie978/Gaming-studies/commits/main)
[![GitHub repo size](https://img.shields.io/github/repo-size/alvie978/Gaming-studies)](https://github.com/alvie978/Gaming-studies)
...
2. Clean the dataset by handling missing values and formatting variables
...
2. Game pricing plays an important role in accessibility. The analysis suggests that games priced below $200 tend to attract more players, indicating that reasonable pricing may help increase adoption and engagement.

3. Negative comments are not a dominant factor affecting game popularity. While reviews provide useful feedback, the analysis indicates that negative comments alone do not strongly determine whether a game becomes popular.
...
2.  **Run the Analysis**: Open `Game_Analyze.ipynb` in Google Colab or Jupyter Notebook. Run the cells sequentially to perform the analysis and generate the visualizations.
3.  **Interpret the Findings**: The notebook's markdown cells and output charts will guide you through the key insights regarding factors influencing game popularity.
